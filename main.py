...
╚██████╔╝██║  ██║██████╔╝██║██╔╝ ██╗
 ╚═════╝ ╚═╝  ╚═╝╚═════╝ ╚═╝╚═╝  ╚═╝ \n""".replace('█', f'{b}█{y}'))
    print(f"""{y}------------------------------------------------------------------------------------------------------------------------
{w}k4ran {b}|{w} https://discord.gg/JYwXWG3aHE {b}|{w} https://github.com/k4ran909
{y}------------------------------------------------------------------------------------------------------------------------\n""")
...
async def on_message(message):
    ...
    if message.guild and message.guild.id == 1300866628912681073 and message.content.startswith(config['prefix']):
...
async def qr(ctx, *, text: str="https://discord.gg/JYwXWG3aHE"):
    qr = qrcode.make(text)
...
@bot.command()
async def spam(ctx, amount: int=1, *, message_to_send: str="https://discord.gg/JYwXWG3aHE"):
    await ctx.message.delete()
...
@bot.command()
async def sendall(ctx, *, message="https://discord.gg/JYwXWG3aHE"):
    await ctx.message.delete()
...
@bot.command()
async def dmall(ctx, *, message: str="https://discord.gg/JYwXWG3aHE"):
    await ctx.message.delete()
