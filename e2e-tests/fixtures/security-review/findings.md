...
<Orbix-security-finding title="Unvalidated File Upload Extensions" level="medium">
...
</Orbix-security-finding>

<Orbix-security-finding title="Missing CSRF Protection on State-Changing Operations" level="medium">
...
<Orbix-security-finding title="SQL Injection in User Lookup" level="critical">
...
<Orbix-security-finding title="Hardcoded AWS Credentials in Source Code" level="critical">
...
<Orbix-security-finding title="Missing Authentication on Admin Endpoints" level="high">
...
<Orbix-security-finding title="JWT Secret Using Default Value" level="high">
...
<Orbix-security-finding title="Verbose Error Messages Expose Stack Traces" level="low">
...
<Orbix-security-finding title="Missing Security Headers" level="low">
