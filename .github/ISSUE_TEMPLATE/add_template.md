---
name: Add Template
about: Request to add a template to Orbix Hub
title: "Add Template: [Template Name]"
labels: "add-template"
assignees: ""
---

If you'd like to add a template to Orbix Hub, follow the [Add Template guide](https://orbix.sh/docs/templates/add-template).
