...
export function ContextFilesPicker() {
  ...
  const isSmartContextEnabled =
    settings?.enableOrbixPro && settings?.enableProSmartFilesContextMode;
                ...
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-[300px]">
                    {isSmartContextEnabled ? (
                      <p>
                        With Smart Context, ORBIX uses the most relevant files as
                        context.
                      </p>
                    ) : (
                      <p>By default, ORBIX uses your whole codebase.</p>
                    )}
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
          ...
          <TooltipProvider>
            {contextPaths.length > 0 ? (
              ...
              <div className="rounded-md border border-dashed p-4 text-center">
                <p className="text-sm text-muted-foreground">
                  {isSmartContextEnabled
                    ? "ORBIX will use Smart Context to automatically find the most relevant files to use as context."
                    : "ORBIX will use the entire codebase as context."}
                </p>
              </div>
            )}
          </TooltipProvider>
