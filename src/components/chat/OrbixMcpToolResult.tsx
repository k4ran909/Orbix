...
interface OrbixMcpToolResultProps {
  node?: any;
  children?: React.ReactNode;
}

export const OrbixMcpToolResult: React.FC<OrbixMcpToolResultProps> = ({
  node,
  children,
}) => {
  ...
  const prettyJson = useMemo(() => {
    ...
    try {
      ...
      console.error("Error parsing JSON for Orbix-mcp-tool-result", e);
      return raw;
    }
  }, [expanded, raw]);
