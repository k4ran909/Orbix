  ...
  const status = useMemo(() => {
    if (hasSavedSettings) {
      return {
        ...
        description:
          "ORBIX will use the credentials saved in Settings for Azure OpenAI models.",
        icon: KeyRound,
        titleClassName: "",
          ...
          <AccordionContent className="pt-4 space-y-4">
            ...
            <div className="text-sm text-muted-foreground space-y-2">
              <p>
                ...
                If both variables are present and no settings are saved, ORBIX
                will use them automatically.
              </p>
              <p>
                Values saved in Settings take precedence over environment
                variables. Restart ORBIX after changing environment variables.
              </p>
            </div>
          </AccordionContent>
        </AccordionItem>
