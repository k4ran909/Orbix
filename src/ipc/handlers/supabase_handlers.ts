...
export function registerSupabaseHandlers() {
  ...
  // Set app project - links a Orbix app to a Supabase project
  handle(
  ...
  // Unset app project - removes the link between a Orbix app and a Supabase project
  ...
  testOnlyHandle(
    ...
    async (
      ...
      safeSend(event.sender, "deep-link-received", {
        ...
        url: "https://supabase-oauth.orbix.sh/api/connect-supabase/login",
      });
      logger.info(
