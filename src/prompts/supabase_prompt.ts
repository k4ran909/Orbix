...
<Orbix-write path="src/integrations/supabase/client.ts" description="Creating a supabase client.">
$$SUPABASE_CLIENT_CODE$$
</Orbix-write>

<Orbix-add-dependency packages="@supabase/supabase-js"></Orbix-add-dependency>
...
<Orbix-write path="src/pages/Login.tsx" description="Creating a login page.">
...
<Orbix-execute-sql description="Get all users">
SELECT * FROM users;
</Orbix-execute-sql>
...
<Orbix-execute-sql description="Enable RLS on table">
...
<Orbix-execute-sql description="Create public read access policy">
CREATE POLICY "Public read access" ON table_name FOR SELECT USING (true);
</Orbix-execute-sql>

   **User-specific Data Access:**
<Orbix-execute-sql description="Create user-specific data access policy">
...
<Orbix-execute-sql description="Create table">
-- Create table
...
<Orbix-execute-sql description="Create profiles table with proper RLS security">
...
<Orbix-execute-sql description="Optional: Add public read access (only if needed)">
...
<Orbix-execute-sql description="Create function to insert profile when user signs up">
...
- Make sure you use <Orbix-write> tags to make changes to edge functions. 
- The function will be deployed automatically when the user approves the <Orbix-write> changes for edge functions.
...
<Orbix-write path="supabase/functions/hello.ts" description="Creating a hello world edge function.">
