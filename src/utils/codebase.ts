...
const ALLOWED_EXTENSIONS = [
  ...
  ".swift",
  // Edge cases
  // https://github.com/K4ran909/Orbix/issues/880
  ".py",
  // https://github.com/K4ran909/Orbix/issues/1221
  ".php",
];
...
//
// ex: https://github.com/K4ran909/Orbix/issues/727
const EXCLUDED_DIRS = [
  "node_modules",
  ".git",
  "dist",
...
async function formatFile({
  ...
  try {
    ...
    if (!shouldReadFileContents({ filePath, normalizedRelativePath })) {
      return `<Orbix-file path="${normalizedRelativePath}">
